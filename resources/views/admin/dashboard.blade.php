                                    ...
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            <div class="media-body mr-3">
                                                ...
                                                <span class="fs-14">Total Older To Day  </span>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            <div class="media-body mr-3">
                                                ...
                                                <span class="fs-14">Total Book A Table</span>
                                            </div>
                                            <svg width="36" height="36" viewBox="0 0 36 36" fill="none"
                                                xmlns="../../../www.w3.org/2000/svg.html">
                                                <path
                                    ...
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            <div class="media-body mr-3">
                                                ...
                                                <span class="fs-14">Total Comment</span>
                                            </div>
                                ...
                                <div class="card">
                                    <div
                                        ...
                                        <div class="mr-auto pr-3 mb-3">
                                            <h4 class="text-black fs-20 mb-sm-0 mb-2">Older Created</h4>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-xxl-12 col-md-6">
                                <div class="card">
                                    <div class="card-header shadow-sm">
                                        <div class="mr-2">
                                            <h4 class="fs-20 mb-0 font-w600 text-black">Task Requests</h4>
                                    ...
                                    <div class="card-body loadmore-content height620 dlab-scroll  pb-0"
                                        ...
                                        <div class="border-bottom pb-4 mb-4">
                                            <a href="javascript:void(0)"
                                                class="btn btn-sm btn-success rounded-xl mb-2">Total Older Delviry</a>
                                            <p class="font-w600"><a href="post-details.html" class="text-black">Total Older Delviry</a></p>
                                            <div class="row justify-content-between">
                                                <ul class="users col-6">
                                                    <li><img src="{{ asset( 'assetsAdmin') }}/images/users/1.jpg" alt=""></li>
                                                    <li><img src="{{ asset( 'assetsAdmin') }}/images/users/2.jpg" alt=""></li>
                                                    <li><img src="{{ asset( 'assetsAdmin') }}/images/users/3.jpg" alt=""></li>
                                                    <li><img src="{{ asset( 'assetsAdmin') }}/images/users/4.jpg" alt=""></li>
                                                </ul>
                                                <div class="col-6 pl-0">
                                                    <h6 class="fs-14">Delivry
                                        ...
                                        <div class="border-bottom pb-4 mb-4">
                                            <a href="javascript:void(0)"
                                                class="btn btn-sm btn-secondary rounded-xl mb-2">Olders</a>
                                            <p class="font-w600"><a href="post-details.html" class="text-black">Quantity of daily orders                                            </a></p>
                                            <div class="row justify-content-between">
                                                <ul class="users col-6">
                                                    <li><img src="{{ asset( 'assetsAdmin') }}/images/users/5.jpg" alt=""></li>
                                                    <li><img src="{{ asset( 'assetsAdmin') }}/images/users/6.jpg" alt=""></li>
                                                    <li><img src="{{ asset( 'assetsAdmin') }}/images/users/7.jpg" alt=""></li>
                                                    <li><img src="{{ asset( 'assetsAdmin') }}/images/users/8.jpg" alt=""></li>
                                                </ul>
                                                <div class="col-6 pl-0">
                                                    <h6 class="fs-14"> outside 
                                        ...
                                        <div class="border-bottom pb-4 mb-4">
                                            <a href="javascript:void(0)"
                                                class="btn btn-sm btn-warning rounded-xl mb-2">inside the restaurant</a>
                                            <p class="font-w600"><a href="post-details.html" class="text-black">Orders inside the restaurant
                                            </a></p>
                                            <div class="row justify-content-between">
                                                <ul class="users col-6">
                                                    <li><img src="{{ asset( 'assetsAdmin') }}/images/users/9.jpg" alt=""></li>
                                                    <li><img src="{{ asset( 'assetsAdmin') }}/images/users/10.jpg" alt=""></li>
                                                    <li><img src="{{ asset( 'assetsAdmin') }}/images/users/11.jpg" alt=""></li>
                                                    <li><img src="{{ asset( 'assetsAdmin') }}/images/users/12.jpg" alt=""></li>
                                                </ul>
                                                <div class="col-6 pl-0">
                                                    <h6 class="fs-14">inside
                                        ...
                                        <div class="border-bottom pb-4 mb-4">
                                            <a href="javascript:void(0)"
                                                class="btn btn-sm btn-secondary rounded-xl mb-2">outside the restaurant</a>
                                            <p class="font-w600"><a href="post-details.html" class="text-black">Orders outside the restaurant</a></p>
                                            <div class="row justify-content-between">
                                                <ul class="users col-6">
                                                    <li><img src="{{ asset( 'assetsAdmin') }}/images/users/5.jpg" alt=""></li>
                                                    <li><img src="{{ asset( 'assetsAdmin') }}/images/users/6.jpg" alt=""></li>
                                    ...
                                    <div class="card-footer">
                                        <a href="javascript:void(0)" class="btn d-block btn-primary light dlab-load-more"
                            ...
                            <div class="col-xl-6 col-xxl-12 col-md-6">
                                <div class="card">
                                    <div class="card-header shadow-sm">
                                        <div class="mr-2">
                                            <h4 class="fs-20 mb-0 font-w600 text-black">Book A Table</h4>
                                        </div>
                                        <a href="contacts.html" class="plus-icon"><i class="fa fa-plus"
                                                aria-hidden="true"></i></a>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="media mb-4">
                                            <div class="image-bx mr-sm-4 mr-2">
                                                <img src="{{ asset( 'assetsAdmin') }}/images/users/1.png" alt=""
                                        ...
                                        <div class="media mb-4">
                                            <div class="image-bx mr-sm-4 mr-2">
                                                <img src="{{ asset( 'assetsAdmin') }}/images/users/2.png" alt=""
                                                    class="rounded-circle img-1">
                                                <span class="active"></span>
                                            </div>
                                            <div
                                        ...
                                        <div class="media">
                                            <div class="image-bx mr-sm-4 mr-2">
                                                <img src="{{ asset( 'assetsAdmin') }}/images/users/3.png" alt=""
                                                    class="rounded-circle img-1">
                                            </div>
                                            <div
                                                class="media-body d-sm-flex justify-content-between d-block align-items-center">

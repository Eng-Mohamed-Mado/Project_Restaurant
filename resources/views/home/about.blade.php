...
@section('content')
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 wow fadeInLeft" data-wow-duration="1s">
                    <div class="about_us_img">
                        <div class="img">
                            <img src="{{ asset( 'assets') }}/images/1.jpg" alt="about us" class="img-fluid w-100">
                        </div>
    ...
    <section class="mission mt_100 xs_mt_70" style="background: url({{ asset( 'assets') }}/images/mission_bg.png);">
            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-lg-5 wow fadeInRight" data-wow-duration="1s">
                    <div class="about_choose_img">
                        <img src="{{ asset( 'assets') }}/images/why_choose_img.jpg" alt="about us" class="img-fluid w-100">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="counter_part mt_100 xs_mt_70" style="background: url({{ asset( 'assets') }}/images/counter_bg.jpg);">
        ...
        <div class="container">
            ...
            <div class="row testi_slider">
                <div class="col-xl-6 wow fadeInUp" data-wow-duration="1s">
                    <div class="single_testimonial">
                        <div class="single_testimonial_img">
                            <img src="{{ asset( 'assets') }}/images/7.jpg" alt="testimonial" class="img-fluid w-100">
                        </div>
                ...
                <div class="col-xl-6 wow fadeInUp" data-wow-duration="1s">
                    <div class="single_testimonial">
                        <div class="single_testimonial_img">
                            <img src="{{ asset( 'assets') }}/images/4.jpg" alt="testimonial" class="img-fluid w-100">
                        </div>
                        <div class="single_testimonial_text">
                            <h4>Ahmed Mohamed</h4>
                            <p class="designation">Cairo Egypt</p>
                ...
                <div class="col-xl-6 wow fadeInUp" data-wow-duration="1s">
                    <div class="single_testimonial">
                        <div class="single_testimonial_img">
                            <img src="{{ asset( 'assets') }}/images/5.jpg" alt="testimonial" class="img-fluid w-100">
                        </div>
                        <div class="single_testimonial_text">
                            <h4>bassent Emad</h4>
                            <p class="designation">Cairo Egypt</p>
